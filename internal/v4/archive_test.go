...
func (s *ArchiveSuiteUnconfiguredTerms) assertUploadCharm(c *gc.C, method string, url *router.ResolvedURL, charmName string) *charm.CharmArchive {
...
func (s *ArchiveSuiteUnconfiguredTerms) assertUploadBundle(c *gc.C, method string, url *router.ResolvedURL, bundleName string) {
...
func (s *ArchiveSuiteUnconfiguredTerms) assertUpload(c *gc.C, method string, url *router.ResolvedURL, fileName string) (size int64) {
...
func (s *ArchiveSuiteUnconfiguredTerms) assertEntityInfo(c *gc.C, url *router.ResolvedURL, expect entityInfo) {
	httptesting.AssertJSONCall(c, httptesting.JSONCallParams{
		Handler: s.srv,
		URL: storeURL(
